...
- Consumers (Coder/Architector/Reviewer tasks) rely on this contract as operational constraints, not as executable TypeScript.
...
- Operationally paired with codemap/coder flows in `src/index.ts` orchestrations for post-feature readability hardening.
