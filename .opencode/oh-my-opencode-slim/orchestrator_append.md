...
3. **Include the ID in the dispatch payload** — the researcher's task text MUST contain `"Write to knowledge/<returned-id>/sources/"` (the exact path with the pre-allocated ID).
