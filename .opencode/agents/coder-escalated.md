...
A single dispatch per escalation. NEVER retry on the same task. If the task
fails, the orchestrator asks the developer via wait_for_user before another
paid escalation is attempted.
