...
| `session_spawn`                                                      | Open generation                                             | Keep              | Attach to the current generation; never increment by itself                                                |
