...
path, syntax error) fails loudly, and it marks the seam where real JWT/OAuth
logic — and its tests — will land. An import test is meaningful here precisely
because the module is importable only via the PEP 420 namespace-package layout
set up in conftest.py; a wrong sys.path setup fails it.
"""
