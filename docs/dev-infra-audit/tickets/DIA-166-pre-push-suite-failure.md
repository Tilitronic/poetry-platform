# DIA-166 - pre-push blocked: make test-shell fails inside hook (unshare 127 + guard-flag interaction suspicion)

<!-- RENUMBERED 2026-08-14 (phase 1, remote lineage canonical, DIA-153): local DIA-123 collided with origin/omo-slim-changes ticket DIA-147-pre-push-suite-failure.md (different ticket). Renumbered to DIA-166. This ticket duplicates remote DIA-147-pre-push-suite-failure.md (same work, renumbered on the remote lineage via bab080c); SUPERSEDED by the remote ticket. -->

<!-- Docs-lane ticket filed 2026-08-12 after a push attempt was blocked by the
     husky pre-push hook following the DIA-165 commit. Two distinct suspects
...
- Suspicion A (guard-flag inheritance): DIA-165's fix exports
  ...
  0), breaking assertions. DIA-165's verification ran the suite
...
Related: DIA-165 (recursion guard fix - suspicion that inherited
