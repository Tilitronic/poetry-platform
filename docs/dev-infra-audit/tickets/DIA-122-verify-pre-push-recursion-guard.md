# DIA-122 - verify-pre-push recursion fork-bomb: root-cause fix (DIA-118 regression)
...
Root cause: commit 49d587a (DIA-118) wired `make test-shell` into
...
Related: DIA-118 (regression source), DIA-071 (env gates).
